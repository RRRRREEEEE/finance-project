...
| `AI协作指令_v2.md` | 📥 @import 自动加载 | — |
| `笔记制作SOP.md` | 📥 @import 自动加载 | — |
| `笔记检查清单.md` | 📥 @import 自动加载 | — |
| 用户指令与偏好记录.md | 📖 手动 | 不理解"为什么"时 |
| 源文件清单.md | 📖 手动 | 开始新课程前，了解有哪些源文件 |
| 术语登记表.md | 📖 手动 | 建笔记前查重，避免跨课程建重复 |
| 知识库整理方案.md | 📖 手动 | 跨课程/去重时 |
| 问题解决与标准化.md | 📖 手动 | 遇到报错时 |
| 变更日志.md | 📖 手动 | 想知道改了什么时 |
| 模板版本.md | 📖 手动 | 怀疑旧笔记模板不一致时 |
| 课程毕业标准.md | 📖 手动 | 章节/课程完成前自检 |
| 会话收尾更新清单.md | 📖 手动 | 人类说"更新你要更新的"时 |
| 人机协作模式手册.md | 📖 手动 | 遇到新的协作场景不确定怎么分工时 |
